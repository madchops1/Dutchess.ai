/*
 ...
 ( o.o )
  > ^ <
DUTCHESS.AI - "NALA"
Machine learning component of Nala.
    ...
    function uploadCsvToS3(step) {
      ...
      s3.putObject(params, function(err, data) {
        if (err) {
          ...
          console.log(
            "Step 5: Successfully Uploaded Data To " +
              bucketName +
              "/" +
              keyName
          );
    ...
    function createMlTrainingDatasource(step) {
      ...
      var params = {
        ...
        DataSpec: {
          ...
          DataRearrangement:
            '{"splitting":{"percentBegin":0, "percentEnd":50, "strategy":"random"}}',
          DataSchema: dataSchema
        },
        ComputeStatistics: true,
        DataSourceName:
          "Nanana Strategy Training 0-50 " + moment().format("YYYY-MM-DD")
      };
    ...
    function createMlTrainingDatasource(step) {
      ...
      var params = {
        ...
        DataSpec: {
          DataLocationS3: "s3://" + bucketName + "/" + keyName,
          DataRearrangement:
            '{"splitting":{"percentBegin":50, "percentEnd":100, "strategy":"random"}}',
          DataSchema: dataSchema
        },
        ComputeStatistics: true,
        DataSourceName:
          "Nana Strategy Evaluation 50-100 " + moment().format("YYYY-MM-DD")
      };
        ...
        mL.getMLModel(params, function(err, data) {
          if (err) {
            ...
            if (data.Status !== "COMPLETED") {
              console.log(
                "Step 8: Machine Learning Model is " +
                  data.Status +
                  ", waiting 30 sec..."
              );
              sleep.sleep(30);
              ...
              mL.createRealtimeEndpoint(params, function(err, data) {
                if (err) {
                  ...
                  console.log(
                    "Step 8.1: Realtime Prediction Endpoint Created Successfully"
                  );
                  step();
                }
              });
