        ...
        function getContract(step) {
            ...
            function findContract() {
                scraperjs.StaticScraper.create(
                    ...
                    .scrape(function($) {
                        return $('#calendarFuturesProductTable1 > tbody > tr:nth-child(' + i + ')')
                            .map(function() {
                                return $(this).text();
                            })
                            .get();
                ...
                mL.getMLModel(params, function(err, data) {
                    if (err) {
                        ...
                        if (data.EndpointInfo.EndpointStatus !== 'READY') {
                            console.log(
                                'Step 15: Endpoint is ' + data.EndpointInfo.EndpointStatus + ', waiting 30 sec...'
                            );
                            sleep.sleep(30);
                            ...
                            mL.predict(params, function(err, data) {
                                if (err) {
                                    ...
                                    console.log(
                                        'Step 15: Predict Binary Change Direction Successful, ' + predictionDirection
                                    );
                                    step();
                                }
                            });
